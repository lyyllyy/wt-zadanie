    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="footer-bottom">
          ...
          <div>
            <p>
            Vaše údaje spracovávame v súlade s nariadením GDPR. Vaše osobné údaje nebudú nikdy zdieľané s tretími stranami bez vášho výslovného súhlasu. Máte právo kedykoľvek požiadať o prístup, opravu alebo vymazanie vašich údajov.
